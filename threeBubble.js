/*
 * CRYPTO | Shader moon V.3
 * experiment: https://tinyurl.com/2p92u52d
 * build 27.11.21 @ 14:50
 */

// this part is loaded from github (injects long shader def)
/*
// hack inject shader into script as textContent
...
function injectScript() {
  ...
  document.getElementById("ortho-vs").textContent = orthoVs;
  document.getElementById("noiseVertexShader").textContent = noiseVertexShader;
  document.getElementById("fs_ZoomBlur").textContent = fs_ZoomBlur;
  document.getElementById("fragmentShader").textContent = fragmentShader;
  document.getElementById("fs_Composite").textContent = fs_Composite;
} // end injectScript()
*/
...
var wrapperBubble = document.querySelector("#wrapper-bubble");

//--------------------------------------------------------------------
function createWorld() {
  _width = wrapperBubble.offsetWidth;
  _height = wrapperBubble.offsetHeight;
  //---
  ...
  //---
  wrapperBubble.appendChild(renderer.domElement);
  //---
